...
class TableExtractor:
    ...
    def execute(self):
        ...
        self.sharpen_image()
        self.store_process_image("12_sharpened_perspective_corrected.jpg", self.sharpened_perspective_corrected_image)
    ...
    def sharpen_image(self):
        ...
        self.sharpened_perspective_corrected_image = cv2.filter2D(self.perspective_corrected_image, -1, kernel)

    def add_10_percent_padding(self):
        image_height = self.image.shape[0]
        padding = int(image_height * 0.1)
        self.perspective_corrected_image_with_padding = cv2.copyMakeBorder(self.sharpened_perspective_corrected_image, padding, padding, padding, padding, cv2.BORDER_CONSTANT, value=[255, 255, 255])
